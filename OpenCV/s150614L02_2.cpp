...
void median_opencvCommand(int kernelsize, void *userData);
string type2str(int type);

using namespace std;

void median_opencvCommand(
...
int main(int argc, char *argv[])
{
	...
	int start_value = 0;
	int max_value = 15;
	createTrackbar("KernelSize", window_name, &start_value, max_value, median_opencvCommand, static_cast<void*>(&window_name));
